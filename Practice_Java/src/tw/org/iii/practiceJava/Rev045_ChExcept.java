...
//		}
		...
		/*	使用者可選擇單一處理Exception 或 各自處理
		 * 	如果不使用T.C, 可在Main方法再throws Exception, 
		 * 	語法上合乎規則但沒有意義!
		 * 	因為同樣是交由JVM處理
		 */
		try {
...
class RevBird2 extends RevBird {
//	@Override
//	void setLeg(int leg) throws ParseException{
//		/*	實作的內容有什麼例外, 就要宣告出來.
//		 * 	但是如果沒有宣告完整, 裡面要使用try catch處理
//		 */
//		try {
//			super.setLeg(leg);
//		} catch (IOException e) {
